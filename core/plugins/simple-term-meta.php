<?php
/**
 Original Plugin: Simple Term Meta
 URI: http://www.cmurrayconsulting.com/software/wordpress-simple-term-meta/
 ...
 Author URI: http://www.cmurrayconsulting.com
 	...
 	Copyright 2009 C. Murray Consulting  (email : jake@cmurrayconsulting.com)
...
// @Changed: Pointed activation hook to store plugin
register_activation_hook( trailingslashit( pp() ) . 'store.php', 'simple_term_meta_install' );
...
// @Changed: Pointed uninstall hook to root of store plugin
register_uninstall_hook( trailingslashit( pp() ) . 'store.php', 'simple_term_meta_uninstall' );
